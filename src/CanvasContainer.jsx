    ...
    <Canvas className='canvasContainer' flat shadows camera={{ position: [0, 0, 20], fov: 17.5, near: 10, far: 40 }} dpr={[1, 1.5]} gl={{ antialias: false }}>
      ...
      {/* <Environment preset='studio'>
        ...
        <group rotation={[-Math.PI / 3, 0, 1]}>
          ...
          <Lightformer form="ring" color="#ddc88c" intensity={80} onUpdate={(self) => self.lookAt(0, 0, 0)} position={[10, 10, 0]} scale={10} />
        </group>
      </Environment>
    </Canvas>
  )
  ...
  return (
    <RigidBody linearDamping={4} angularDamping={1} friction={0.1} position={pos} ref={api} colliders={false}>
      ...
      <mesh ref={ref} castShadow receiveShadow>
        ...
        <meshStandardMaterial color="#ddc88c" roughness={0.5} metalness={0.6} transparent={false} opacity={1} />
      </mesh>
    </RigidBody>
  )
}
